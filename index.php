        ...
        <div class="col-lg-3 py-0 px-3 h-100 shadow-sm text-center custom-card" id="left-card">
            <div class="row py-4 ">
                <div class="col-md-5 d-flex align-items-center justify-content-center">
                    <img alt="profile picture" class="img-fluid rounded p-1 shadow" style="max-height: 128px" src="http://localhost:8000/profile_images/<?php echo htmlspecialchars($user_data->image_name); ?>">
                </div>
